...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DATASETDOWNLOADCOMPLETE']._serialized_start=44
  _globals['_DATASETDOWNLOADCOMPLETE']._serialized_end=126
